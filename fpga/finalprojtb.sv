module finalprojtb();
    ...
    initial begin
            ...
            vectornum=5'd1; sck=1'b1; cs=1'b1; sdi=1'b1; #10;  
            vectornum=5'd2; sck=1'b0; cs=1'b1; sdi=1'b1; #10;
            ...
            vectornum=5'd11; sck=1'b1; cs=1'b1; sdi=1'b0; #10;
            vectornum=5'd12; sck=1'b0; cs=1'b1; sdi=1'b0; #10;
            vectornum=5'd13; sck=1'b1; cs=1'b1; sdi=1'b0; #10;
            vectornum=5'd14; sck=1'b0; cs=1'b1; sdi=1'b0; #10;
            vectornum=5'd15; sck=1'b1; cs=1'b1; sdi=1'b0; #10;
            vectornum=5'd16; sck=1'b0; cs=1'b1; sdi=1'b0; #10;
            ...
            vectornum=5'd25; sck=1'b1; cs=1'b1; sdi=1'b1; #10; 
            vectornum=5'd26; sck=1'b0; cs=1'b1; sdi=1'b1; #10;
            ...
            vectornum=5'd31; sck=1'b1; cs=1'b1; sdi=1'b0; #10;
            vectornum=5'd32; sck=1'b0; cs=1'b1; sdi=1'b0; #10;
            vectornum=5'd33; sck=1'b1; cs=1'b1; sdi=1'b0; #10;
            vectornum=5'd34; sck=1'b0; cs=1'b1; sdi=1'b0; #10;
            vectornum=5'd35; sck=1'b1; cs=1'b1; sdi=1'b0; #10;
            vectornum=5'd36; sck=1'b0; cs=1'b1; sdi=1'b0; #10;
            vectornum=5'd37; sck=1'b1; cs=1'b1; sdi=1'b0; #10;
            vectornum=5'd38; sck=1'b0; cs=1'b1; sdi=1'b0; #10;
            ...
            vectornum=5'd59; sck=1'b1; cs=1'b1; sdi=1'b0; #10;
            vectornum=5'd60; sck=1'b0; cs=1'b1; sdi=1'b0; #10;
